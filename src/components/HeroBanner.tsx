...
const HeroBanner: React.FC = () => {
  ...
  const images = [
    "/src/assets/images/Ventilator CH3000.PNG",
    "/src/assets/images/Ultrasound Scanner CM300.PNG",
    "/src/assets/images/TH RBIT 34RR045S HD.PNG",
    "/src/assets/images/Three Phase Brake Motors.PNG",
    "/src/assets/images/Ultrasound Scanner CW500.PNG",
    "/src/assets/images/Thermoplastic Centrifugal Pump.PNG",
    "/src/assets/images/16 Channel Security Camera System, 4K AI IP Cameras w Motorized Zoom.PNG",
    "/src/assets/images/Heavy Duty Sewage Pump.PNG",
    "/src/assets/images/Energy Efficient Three Phase Motor.PNG",
    "/src/assets/images/TH RBIT 28R038M.PNG",
    "/src/assets/images/End Suction Fire Pump FLBS.PNG",
    "/src/assets/images/CastIron Submersible Pump.jpg",
    "/src/assets/images/Auto-Tracking PTZ Camera 40 Zoom.JPG",
    "/src/assets/images/TH RBIT 34RR048S.PNG",
    "/src/assets/images/Auto-Tracking PTZ Camera 25 Zoom.JPG",
    "/src/assets/images/32Channel NVR Camera System w16 Dome.JPG",
    "/src/assets/images/32ch NVR System, 4k 8mp AI Security Cameras Dome Infrared PoE, Audio.PNG",
  ];
